    ...
    userTablePagination +=
      ...
      <ul class="pagination">
        <li class="page-item ${page <= 1 ? 'disabled' : ''}">
          <a class="page-link" href="javascript:pageChange(${page - 1})">上一頁</a>
        </li>`

    for (let i = page - 3; i <= totalPages; i++) {
      if (i < 1) continue;
      userTablePagination +=
        `<li class="page-item ${i === page ? 'active' : ''}"><a class="page-link" href="javascript:pageChange(${i})">${i}</a></li>`
    }

    userTablePagination +=
      `<li class="page-item ${page >= totalPages ? 'disabled' : ''}">
          <a class="page-link" href="javascript:pageChange(${page + 1})">下一頁</a>
        </li>
      </ul>
    </nav>
    </td></tr>`;
